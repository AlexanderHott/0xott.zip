...
<div class="bg-neutral-900 p-4 rounded-lg">
  ...
  <div class="text-center text-2xl font-bold">
    <span class="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">//</span>
    Commentlyly
  </div>
...
The greatest part, is that once your code has comments on everything,
you'll need AI to keep them up to date.
...
Well this is a pretty complex function, we should add some documentation on how to use it.
...
Now the frontend team goes to implement the sign-in page and sees the following documentation when they hover over the function.
...
Keeping specific details in the docstring is a bad idea. Instead, we can
show a few examples of how the function works, and if the implementation 
details are so important, **just read the code**.
...
[Tom](https://thedailywtf.com/articles/the-inner-json-effect),
but this is very similar to [table](https://go.dev/wiki/TableDrivenTests)
[tests](https://dave.cheney.net/2019/05/07/prefer-table-driven-tests) and preserves 
[locality](https://www.youtube.com/watch?v=eMTFzpxR0QQ) 
